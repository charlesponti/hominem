...
import { PersonalFinanceRouter } from './routers/personal-finance.router'
...
const personalFinance = new PersonalFinanceRouter()
...
export const appRouter = trpc.router({
  ...
  personalFinance: personalFinance.router,
})
