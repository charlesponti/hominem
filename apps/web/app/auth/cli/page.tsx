    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>CLI Authentication</CardTitle>
          <CardDescription>
            Generate an authentication token for the Hominem CLI
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <>
              ...
              <div className="mb-4 grid grid-cols-1 gap-3">
                <div className={`rounded-md p-3 ${
                  user?.externalAccounts?.some(acc => acc.provider === 'google' || acc.provider === 'oauth_google')
              ...
              <div className="mt-4 rounded-md bg-blue-50 p-3 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300">
                ...
                <ol className="ml-4 mt-2 list-decimal space-y-1">
                  ...
                  <li>In your terminal, run: <code className="rounded bg-blue-200 px-1 dark:bg-blue-800/30">hominem api auth --token [paste-token-here]</code></li>
                </ol>
              </div>
              
              {closing && (
                <div className="mt-4 rounded-md bg-green-50 p-3 text-green-800 dark:bg-green-900/20 dark:text-green-300">
                  <p>Authentication successful! This window will close automatically in a few seconds.</p>
                </div>
              )}
            </>
          ) : (
