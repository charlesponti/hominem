...
// is enough to hand the sheet route a read/write handle on that composer's
// draft without threading it through router params or a context above the
// stack. The sheet owns the enhance request itself (see enhance-sheet.tsx)
// and only calls setMessage once, when the user accepts a result.
