    ...
    <div className={cn('prose prose-sm dark:prose-invert max-w-none', className)}>
      <ReactMarkdown
        components={{
          ...
          // Headings
          h1: ({ children }) => (
            <h1 className="heading-3 mt-6 mb-4 first:mt-0">{children}</h1>
          ),
          h2: ({ children }) => (
            <h2 className="heading-4 mt-5 mb-3 first:mt-0">{children}</h2>
          ),
          h3: ({ children }) => (
            <h3 className="heading-4 mt-4 mb-2 first:mt-0">{children}</h3>
          ),
          // Paragraphs
