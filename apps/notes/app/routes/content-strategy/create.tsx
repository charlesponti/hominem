...
MONETIZATION IDEAS:
${strategy.monetization?.map((idea) => `• ${idea}`).join('\n') || 'No monetization ideas available'}
          ...
          <div className="mt-6 space-y-6">
            ...
            <Tabs defaultValue="insights" className="w-full">
                  ...
                  {strategy.contentPlan?.blog ? (
                    <>
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-sm">
                          {strategy.contentPlan.blog.callToAction || 'No call to action available'}
                        </p>
                      </div>
                    </>
                  ) : (
                          ...
                          <div className="mt-2">
                            ...
                            <ul className="list-disc pl-5 space-y-1 text-sm">
                              {platform.contentIdeas.map((idea: string) => (
                                <li key={getUniqueId(`idea-${platform.platform}`, idea)}>{idea}</li>
                              ))}
                            </ul>
                          </div>
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        strategy.contentPlan.visualContent.infographicIdeas.length > 0 ? (
                          ...
                          <p className="text-gray-500 text-sm">No infographic ideas available</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        strategy.contentPlan.visualContent.imageSearchTerms.length > 0 ? (
                          ...
                          <p className="text-gray-500 text-sm">No image search terms available</p>
                        )}
                      </div>
                    </div>
                  ) : (
              ...
              <TabsContent value="monetization" className="p-4 border rounded-md mt-2">
                ...
                {strategy.monetization && strategy.monetization.length > 0 ? (
                  <ul className="list-disc pl-5 space-y-1">
                    {strategy.monetization.map((idea: string) => (
