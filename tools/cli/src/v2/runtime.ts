...
import type { CommandDefinition, CommandFailure, CommandSuccess, JsonValue, OutputFormat } from './contracts'
...
function normalizeFlagRecord(flags: Record<string, string | boolean>): Record<string, string | boolean> {
