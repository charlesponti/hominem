...
export const QUEUE_NAMES = {
   ...
   * - services/workers/src/transaction-import-worker.ts (processing jobs)
   */
   ...
   * - services/workers/src/plaid-worker.ts (processing jobs)
   */
   ...
   * - services/workers/src/google-calendar-sync-worker.ts (processing jobs)
   */
...
export const REDIS_CHANNELS = {
   ...
   * Used by:
   * - services/workers/src/job-status.service.ts (publishing)
