...
import type { ContactSelect } from '@hominem/db/schema';
import type { ApiResult } from '@hominem/services';
import type { JsonSerialized } from '../types/utils';
...
export type PeopleListOutput = ApiResult<JsonSerialized<ContactSelect>[]>;

export type PeopleCreateOutput = ApiResult<JsonSerialized<ContactSelect>>;

export type PeopleGetOutput = ApiResult<JsonSerialized<ContactSelect>>;

export type PeopleUpdateOutput = ApiResult<JsonSerialized<ContactSelect>>;

export type PeopleDeleteOutput = ApiResult<{ success: true }>;
