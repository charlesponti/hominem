...
export const applicationStageName = pgEnum('application_stage_name', [
  'Applied',
  'Screening',
  'Assessment',
  'Interview',
...
export const applicationStageStatus = pgEnum('application_stage_status', [
  'Pending',
  'Scheduled',
  'InProgress',
  'Completed',
...
export const authDeviceCodeStatus = pgEnum('auth_device_code_status', [
  'pending',
  'approved',
  'denied',
  'expired',
...
export const jobSkillImportance = pgEnum('job_skill_importance', [
  'Required',
  'Preferred',
  'Optional',
  'NiceToHave',
...
export const eventsTransactions = pgTable(
  ...
  (table) => [
    index('events_transactions_event_id_idx').using(
      'btree',
      table.eventId.asc().nullsLast().op('uuid_ops'),
    ),
    index('events_transactions_transaction_id_idx').using(
      'btree',
...
export const item = pgTable(
  ...
  (table) => [
    index('item_itemId_itemType_idx').using(
      'btree',
    ...
    index('item_listId_itemType_idx').using(
      'btree',
      table.listId.asc().nullsLast().op('uuid_ops'),
      table.itemType.asc().nullsLast().op('enum_ops'),
    ),
...
export const movieViewings = pgTable(
  ...
  (table) => [
    index('movie_viewings_movie_id_idx').using(
      'btree',
      table.movieId.asc().nullsLast().op('uuid_ops'),
    ),
    index('movie_viewings_user_id_idx').using(
      'btree',
...
export const mcpToolExecutions = pgTable(
  ...
  (table) => [
    index('idx_mcp_tool_executions_created_at').using(
      'btree',
      table.createdAt.desc().nullsFirst().op('timestamptz_ops'),
    ),
    index('idx_mcp_tool_executions_success').using(
      'btree',
      table.success.asc().nullsLast().op('bool_ops'),
    ),
    index('idx_mcp_tool_executions_tool_name').using(
      'btree',
      table.toolName.asc().nullsLast().op('text_ops'),
    ),
    index('idx_mcp_tool_executions_user_id').using(
      'btree',
      table.userId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
    ...
    pgPolicy('mcp_tool_executions_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
    }),
  ],
);
...
export const mcpSessions = pgTable(
  ...
  (table) => [
    index('idx_mcp_sessions_expires').using(
      'btree',
      table.expiresAt.asc().nullsLast().op('timestamptz_ops'),
    ),
    index('idx_mcp_sessions_token').using(
      'btree',
    ...
    pgPolicy('mcp_sessions_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const surveyVotes = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('survey_votes_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const eventsUsers = pgTable(
  ...
  (table) => [
    index('events_users_event_id_idx').using(
      'btree',
      table.eventId.asc().nullsLast().op('uuid_ops'),
    ),
    index('events_users_person_id_idx').using(
      'btree',
...
export const eventsTags = pgTable(
  'events_tags',
  {
    eventId: uuid('event_id'),
    tagId: uuid('tag_id'),
...
export const users = pgTable(
  ...
  (table) => [
    ...
    index('users_better_auth_user_id_idx').using(
      'btree',
      table.betterAuthUserId.asc().nullsLast().op('text_ops'),
    ),
    uniqueIndex('users_better_auth_user_id_uidx').using(
      'btree',
      table.betterAuthUserId.asc().nullsLast().op('text_ops'),
    ),
    index('users_primary_auth_subject_id_idx').using(
      'btree',
      table.primaryAuthSubjectId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
...
export const authSubjects = pgTable(
  ...
  (table) => [
    uniqueIndex('auth_subject_provider_subject_uidx').using(
      'btree',
      table.provider.asc().nullsLast().op('text_ops'),
      table.providerSubject.asc().nullsLast().op('text_ops'),
    ),
...
export const authDeviceCodes = pgTable(
  ...
  (table) => [
    uniqueIndex('auth_device_code_hash_uidx').using(
      'btree',
      table.deviceCodeHash.asc().nullsLast().op('text_ops'),
    ),
    uniqueIndex('auth_device_user_code_uidx').using(
      'btree',
...
export const authPasskeys = pgTable(
  ...
  (table) => [
    uniqueIndex('auth_passkey_credential_uidx').using(
      'btree',
...
export const authSessions = pgTable(
  ...
  (table) => [
    index('auth_session_state_idx').using(
      'btree',
      table.sessionState.asc().nullsLast().op('text_ops'),
    ),
...
export const interviewInterviewers = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('interview_interviewer_unique_idx').using(
      'btree',
...
export const budgetGoals = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('budget_goals_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const authRefreshTokens = pgTable(
  ...
  (table) => [
    index('auth_refresh_family_idx').using(
      'btree',
      table.familyId.asc().nullsLast().op('uuid_ops'),
    ),
...
export const categories = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('categories_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const list = pgTable(
  ...
  (table) => [
    foreignKey({
      ...
      .onUpdate('cascade')
      .onDelete('cascade'),
    pgPolicy('list_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`("ownerId" = (current_setting('app.current_user_id'::text, true))::uuid)`,
    }),
  ],
);
...
export const financeAccounts = pgTable(
  ...
  (table) => [
    index('finance_accounts_institution_id_idx').using(
      'btree',
      table.institutionId.asc().nullsLast().op('text_ops'),
    ),
    index('finance_accounts_plaid_item_id_idx').using(
      'btree',
      table.plaidItemId.asc().nullsLast().op('uuid_ops'),
    ),
    index('finance_accounts_search_idx').using(
      'gin',
      sql`to_tsvector('english'::regconfig, ((name || ' '::text) || COALE`,
    ),
    foreignKey({
    ...
    pgPolicy('finance_accounts_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const interviews = pgTable(
  ...
  (table) => [
    index('interview_company_id_idx').using(
      'btree',
      table.companyId.asc().nullsLast().op('uuid_ops'),
    ),
    index('interview_job_app_id_idx').using(
      'btree',
      table.jobApplicationId.asc().nullsLast().op('uuid_ops'),
    ),
    index('interview_scheduled_at_idx').using(
      'btree',
    ...
    pgPolicy('interviews_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const financialInstitutions = pgTable(
  ...
  (table) => [
    index('financial_institutions_search_idx').using(
      'gin',
      sql`to_tsvector('english'::regconfig, name)`,
    ),
  ],
);
...
export const betterAuthUser = pgTable(
  ...
  (table) => [
    uniqueIndex('better_auth_user_email_uidx').using(
      'btree',
...
export const betterAuthAccount = pgTable(
  ...
  (table) => [
    uniqueIndex('better_auth_account_provider_account_uidx').using(
      'btree',
      table.providerId.asc().nullsLast().op('text_ops'),
      table.accountId.asc().nullsLast().op('text_ops'),
    ),
    index('better_auth_account_user_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const betterAuthSession = pgTable(
  ...
  (table) => [
    uniqueIndex('better_auth_session_token_uidx').using(
      'btree',
      table.token.asc().nullsLast().op('text_ops'),
    ),
    index('better_auth_session_user_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const betterAuthVerification = pgTable(
  ...
  (table) => [
    index('better_auth_verification_identifier_idx').using(
      'btree',
...
export const notes = pgTable(
  ...
  (table) => [
    ...
    index('notes_published_at_idx').using(
      'btree',
      table.publishedAt.asc().nullsLast().op('timestamp_ops'),
    ),
    index('notes_search_idx').using(
      'gin',
      sql`((((setweight(to_tsvector('english'::regconfig, COALESCE(title,`,
    ),
    ...
    index('notes_version_idx').using(
      'btree',
      table.parentNoteId.asc().nullsLast().op('uuid_ops'),
...
export const plaidItems = pgTable(
  ...
  (table) => [
    index('plaid_items_institution_id_idx').using(
      'btree',
      table.institutionId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
    ...
    pgPolicy('plaid_items_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const jobSkills = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('job_skill_unique_idx').using(
      'btree',
...
export const accountAliases = pgTable(
  ...
  (table) => [unique('account_aliases_alias_key').on(table.alias)],
);
...
export const entityRelationships = pgTable(
  ...
  (table) => [
    unique('entity_relationships_from_entity_id_to_entity_id_relationsh_key').on(
      table.fromEntityId,
      table.toEntityId,
...
export const surveys = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('surveys_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const applicationStages = pgTable(
  ...
  (table) => [
    index('app_stage_job_app_id_idx').using(
      'btree',
      table.jobApplicationId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
...
export const documents = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('documents_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const transactions = pgTable(
  ...
  (table) => [
    index('idx_transactions_search_vector').using(
      'gin',
      table.searchVector.asc().nullsLast().op('tsvector_ops'),
    ),
    index('transactions_account_id_idx').using(
      'btree',
      table.accountId.asc().nullsLast().op('uuid_ops'),
    ),
    index('transactions_category_idx').using(
      'btree',
    ...
    index('transactions_from_account_id_idx').using(
      'btree',
      table.fromAccountId.asc().nullsLast().op('uuid_ops'),
    ),
    index('transactions_to_account_id_idx').using(
      'btree',
      table.toAccountId.asc().nullsLast().op('uuid_ops'),
    ),
    ...
    pgPolicy('transactions_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const budgetCategories = pgTable(
  ...
  (table) => [
    uniqueIndex('budget_categories_name_user_id_unique').using(
      'btree',
      table.name.asc().nullsLast().op('text_ops'),
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    index('budget_categories_search_idx').using(
      'gin',
      sql`to_tsvector('english'::regconfig, name)`,
    ),
    foreignKey({
    ...
    pgPolicy('budget_categories_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const betterAuthDeviceCode = pgTable(
  ...
  (table) => [
    uniqueIndex('better_auth_device_code_device_uidx').using(
      'btree',
      table.deviceCode.asc().nullsLast().op('text_ops'),
    ),
    index('better_auth_device_code_user_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    uniqueIndex('better_auth_device_code_user_uidx').using(
      'btree',
      table.userCode.asc().nullsLast().op('text_ops'),
    ),
  ],
...
export const networkingEvents = pgTable(
  'networking_events',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid('user_id').notNull(),
  ...
  (table) => [
    ...
    pgPolicy('networking_events_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const betterAuthApiKey = pgTable(
  ...
  (table) => [
    ...
    index('better_auth_api_key_user_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const betterAuthPasskey = pgTable(
  ...
  (table) => [
    uniqueIndex('better_auth_passkey_credential_uidx').using(
      'btree',
      table.credentialId.asc().nullsLast().op('text_ops'),
    ),
    index('better_auth_passkey_user_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const possessions = pgTable(
  ...
  (table) => [
    ...
    foreignKey({
      ...
      .onUpdate('cascade')
      .onDelete('restrict'),
    pgPolicy('possessions_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const place = pgTable(
  ...
  (table) => [
    ...
    index('place_location_gist_idx').using(
      'gist',
      table.location.asc().nullsLast().op('gist_geometry_ops_2d'),
    ),
    index('place_updatedAt_idx').using(
      'btree',
...
export const contacts = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('contacts_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const financialSummary = pgTable(
  ...
  (table) => [
    index('idx_financial_summary_period').using(
      'btree',
      table.periodType.asc().nullsLast().op('text_ops'),
    ),
    index('idx_financial_summary_user').using(
      'btree',
      table.userId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
...
export const healthMetrics = pgTable(
  ...
  (table) => [
    index('idx_health_metrics_timestamp').using(
      'btree',
      table.timestamp.asc().nullsLast().op('timestamptz_ops'),
    ),
    index('idx_health_metrics_type').using(
      'btree',
...
export const events = pgTable(
  ...
  (table) => [
    ...
    index('events_user_id_date_idx').using(
      'btree',
    ...
    pgPolicy('events_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const userSkills = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('user_skill_unique_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('uuid_ops'),
      table.skillId.asc().nullsLast().op('uuid_ops'),
    ),
    ...
    pgPolicy('user_skills_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const vectorDocuments = pgTable(
  ...
  (table) => [
    index('vector_documents_embedding_idx').using(
      'hnsw',
      table.embedding.asc().nullsLast().op('vector_cosine_ops'),
    ),
    index('vector_documents_source_idx').using(
      'btree',
      table.source.asc().nullsLast().op('text_ops'),
    ),
    index('vector_documents_source_type_idx').using(
      'btree',
      table.sourceType.asc().nullsLast().op('text_ops'),
    ),
    index('vector_documents_user_id_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
    ...
    pgPolicy('vector_documents_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const workExperiences = pgTable(
  ...
  (table) => [
    index('work_exp_company_id_idx').using(
      'btree',
      table.companyId.asc().nullsLast().op('uuid_ops'),
    ),
    index('work_exp_created_at_idx').using(
      'btree',
      table.createdAt.asc().nullsLast().op('timestamp_ops'),
    ),
    index('work_exp_sort_order_idx').using(
      'btree',
      table.sortOrder.asc().nullsLast().op('int4_ops'),
    ),
    index('work_exp_user_id_idx').using('btree', table.userId.asc().nullsLast().op('uuid_ops')),
    index('work_exp_user_sort_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('uuid_ops'),
      table.sortOrder.asc().nullsLast().op('uuid_ops'),
    ),
    index('work_exp_user_visible_idx').using(
      'btree',
      table.userId.asc().nullsLast().op('uuid_ops'),
      table.isVisible.asc().nullsLast().op('uuid_ops'),
    ),
    ...
    pgPolicy('work_experiences_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const networkingEventAttendees = pgTable(
  ...
  (table) => [
    uniqueIndex('ne_attendee_unique_idx').using(
      'btree',
      table.networkingEventId.asc().nullsLast().op('uuid_ops'),
      table.contactId.asc().nullsLast().op('uuid_ops'),
    ),
    index('nea_contact_id_idx').using('btree', table.contactId.asc().nullsLast().op('uuid_ops')),
    index('nea_event_id_idx').using(
      'btree',
      table.networkingEventId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
...
export const health = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('health_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const jobApplications = pgTable(
  ...
  (table) => [
    index('job_applications_company_id_idx').using(
      'btree',
      table.companyId.asc().nullsLast().op('uuid_ops'),
    ),
    ...
    pgPolicy('job_applications_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
...
export const mealTypes = pgTable(
  ...
  (table) => [unique('meal_types_name_key').on(table.name)],
);

export const transportationTypes = pgTable(
  ...
  (table) => [unique('transportation_types_name_key').on(table.name)],
);
...
export const tripCategories = pgTable(
  ...
  (table) => [unique('trip_categories_trip_id_category_key').on(table.tripId, table.category)],
);
...
export const tripTags = pgTable(
  ...
  (table) => [unique('trip_tags_trip_id_tag_key').on(table.tripId, table.tag)],
);
...
export const googleActivitiesAListOfGoogleServicesAccessedBy = pgTable(
...
export const googleChannelCommunityModerationSettings = pgTable(
...
export const googleDevicesAListOfDevicesIENestPixelIph = pgTable(
...
export const entityTags = pgTable(
  ...
  (table) => [primaryKey({ columns: [table.entityId, table.tagId], name: 'entity_tags_pkey' })],
);

export const tripAttendees = pgTable(
  'trip_attendees',
  {
    tripId: uuid('trip_id').notNull(),
  ...
  (table) => [primaryKey({ columns: [table.tripId, table.personId], name: 'trip_attendees_pkey' })],
);
...
export const listInvite = pgTable(
  ...
  (table) => [
    index('list_invite_email_idx').using(
      'btree',
      table.invitedUserEmail.asc().nullsLast().op('text_ops'),
    ),
    uniqueIndex('list_invite_token_unique').using(
      'btree',
      table.token.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const userArtists = pgTable(
  ...
  (table) => [
    ...
    pgPolicy('user_artists_user_isolation', {
      as: 'permissive',
      for: 'all',
      to: ['mcp_server'],
      using: sql`(user_id = (current_setting('app.current_user_id'::text, true))::uuid)`,
