...
CREATE INDEX app_entities_owner_user_id_idx
  ON app.entities (owner_user_id)
...
CREATE TRIGGER app_tasks_sync_entity_registry
  ...
  FOR EACH ROW
  EXECUTE FUNCTION app.sync_entity_registry('owner_user_id', 'space_id');
...
SELECT 'app.notes'::regclass, id, owner_user_id, NULL
FROM app.notes
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.chats'::regclass, id, owner_user_id, space_id
FROM app.chats
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.people'::regclass, id, owner_user_id, NULL
FROM app.people
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.spaces'::regclass, id, owner_user_id, NULL
FROM app.spaces
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.tasks'::regclass, id, owner_user_id, space_id
FROM app.tasks
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.goals'::regclass, id, owner_user_id, NULL
FROM app.goals
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.places'::regclass, id, owner_user_id, NULL
FROM app.places
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.bookmarks'::regclass, id, owner_user_id, NULL
FROM app.bookmarks
ON CONFLICT DO NOTHING;
...
INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.travel_trips'::regclass, id, owner_user_id, NULL
FROM app.travel_trips
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.finance_accounts'::regclass, id, owner_user_id, NULL
FROM app.finance_accounts
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.finance_transactions'::regclass, id, owner_user_id, NULL
FROM app.finance_transactions
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.music_artists'::regclass, id, owner_user_id, NULL
FROM app.music_artists
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.music_albums'::regclass, id, owner_user_id, NULL
FROM app.music_albums
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.music_tracks'::regclass, id, owner_user_id, NULL
FROM app.music_tracks
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.music_playlists'::regclass, id, owner_user_id, NULL
FROM app.music_playlists
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.video_channels'::regclass, id, owner_user_id, NULL
FROM app.video_channels
ON CONFLICT DO NOTHING;

INSERT INTO app.entities (entity_table, entity_id, owner_user_id, space_id)
SELECT 'app.possessions'::regclass, id, owner_user_id, NULL
  ...
  USING (
    ...
    OR EXISTS (
      ...
      WHERE entity.entity_table = tag_assignments.entity_table
        ...
        AND (
          entity.owner_user_id = auth.current_user_id()
          OR (
...
DROP INDEX IF EXISTS app.app_entities_owner_user_id_idx;
