...
export const DisplayScale: Story = {
  render: () => (
    <div className="flex flex-col gap-6">
      <div>
        <p className="body-4 text-text-tertiary mb-2">display-1</p>
        <p className="display-1 text-text-primary">The quick brown fox</p>
      </div>
      <div>
        <p className="body-4 text-text-tertiary mb-2">display-2</p>
  ...
  render: () => (
    <div className="flex flex-col gap-6">
      {(['heading-1', 'heading-2', 'heading-3', 'heading-4'] as const).map((cls) => (
        <div key={cls}>
          <p className="body-4 text-text-tertiary mb-1">{cls}</p>
