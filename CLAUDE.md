...
The root [AGENTS.md](AGENTS.md) is the sole agent instruction authority for this repository. It points to the `hominem-development` skill for the portless proxy and worktree `.env` bootstrap steps a fresh worktree needs before `pnpm dev` will work.
