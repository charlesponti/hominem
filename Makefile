...
.PHONY: db-migrate db-migrate-test db-migrate-all db-rollback db-rollback-test db-rollback-all db-status db-status-test db-status-all db-v1-migrate db-v1-status db-v1-seed-demo db-v1-verify-fresh db-v1-verify-rls db-v1-verify-relational db-v1-verify-registry db-v1-verify-tags db-v1-verify-rollback db-v1-verify-reset db-v1-verify-tag-performance db-v1-verify-all db-reset-dev db-reset-test db-reset-all db-verify-fresh db-generate-types db-verify-types db-migrate-sync db-rollback-sync db-new-migration help-db
...
help:
	...
	@echo "  make db-v1-migrate | db-v1-status | db-v1-seed-demo | db-v1-verify-fresh | db-v1-verify-rls | db-v1-verify-relational | db-v1-verify-registry | db-v1-verify-tags | db-v1-verify-rollback | db-v1-verify-reset | db-v1-verify-tag-performance | db-v1-verify-all"
...
db-reset-all: db-reset-dev db-reset-test

db-verify-fresh:
	$(call wait_for_db,test,hominem-test-postgres)
	TEST_DATABASE_URL="$(TEST_DATABASE_URL)" bash ./scripts/verify-goose-fresh-db.sh
