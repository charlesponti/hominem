...
const PROBES = [
  ...
  {
    label: 'services/api (application service imports @hominem/chat)',
    file: p('services/api/src/application/chat-generation.service.ts'),
    line: 11,
    offset: 3,
    marker: MARKERS[0].marker,
  },
  {
    label: 'packages/rpc (canonical chat type re-export)',
